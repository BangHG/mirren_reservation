...
const angelList = [
  ...
  { tribe: '1', id: '14', name: '호무라', cv_ja: '네모토 미야리', spec: '<p>생일 : 8/2</p> <p>종족: 비르투스 천사</p> <p>키 : 148cm</p> <p>체중 : 0.13kg * 천사의 체중은 깃털보다 가볍다</p>', desc: '작고 동글동글하게 생겨 귀여운 여동생 같은 이미지가 강하지만  의외로 성숙하고 책임감이 강한 천사.<br> 오랜 세월을 살아왔기 때문에 여동생보다는 손주를 대하듯 따뜻한 할머니의 느낌이 난다.' },
  { tribe: '1', id: '15', name: '디아', cv_ja: '사토미 사토', spec: '<p>생일 : 6/22</p> <p>종족: 비르투스 천사</p> <p>키 : 161cm</p> <p>체중 : 0.18kg * 천사의 체중은 깃털보다 가볍다</p>', desc: '천계의 질서를 상징하는 천사. 늘 차가워 보이고 무정해 <br>보인다.  디아는 천계의 질서를 지키는 사명을 가지고 있어 <br>늘 엄.근.진한 모습을 자주 보여주지만 <br> 속으로는 더 관대해지고 싶어 한다.' },
  ...
  { tribe: '2', id: '24', name: '에어린', cv_ja: '아카오 히카루', spec: '<p>생일 : 7/20</p> <p>종족 : 야고르인</p> <p>키 : 135cm</p> <p>체중 : 32kg</p>', desc: '사파릴 왕국의 둘째 공주. <br> 주변 사람을 잘 챙기며 따뜻한 심성을 가졌다. <br> 암투로 가득한 다른 왕실과는 다르게 <br>매우 행복한 어린 시절을 보냈다. ' },
  { tribe: '2', id: '25', name: '시슬리', cv_ja: '토마츠 하루카', spec: '<p>생일 : 10/11</p> <p>종족 : 야고르인</p> <p>키 : 135cm</p> <p>체중 : 32kg</p>', desc: '이중인격의 소녀.<br> 순수하고 사랑스러운 소녀와 <br>차갑고 잔인한 소녀의 인격을 가지고 있다. ' },
  ...
  { tribe: '3', id: '34', name: '마키', cv_ja: '타무라 유카리', spec: '<p>생일 : 3/15</p> <p>종족 : 오카즈 하프 </p> <p>키 : 145cm</p> <p>체중 : 40kg</p>', desc: '화이트&블랙 컬러의 긴 양 갈래 머리와 <br>오드아이 눈동자를 가지고 있다. <br>평소에는 매우 사납지만, <br>주인 앞에서는 한 마리의 순한 양이 된다.' },
  { tribe: '3', id: '35', name: '샌디', cv_ja: '치넨 아키호', spec: '<p>생일 : 3/18</p> <p>종족 : 콜른 하프 </p> <p>키 : 141cm</p> <p>체중 : 38kg</p>', desc: '매사 적극적으로 남을 돕고<br> 믿음직한 모습을 보여주려고 하지만 <br>강약 조절이 부족해 매번 일을 <br>엉망으로 만들어 버리는 천진난만한 소녀.' },
  ...
  { tribe: '4', id: '44', name: '쿠로신', cv_ja: '키토 아카리', spec: '<p>생일 : 5/25</p> <p>종족 : 플레임 악마</p> <p>키 : 157cm</p> <p>체중 : 45kg</p>', desc: '다른 세계에서 온 인기 아이돌이자 플레임 데빌의 둘째 공주. <br>말이나 행동이 평범한 여고생 같지만, <br>화가 나면 심한 장난으로 보복하는 귀여운 악마.' },
  { tribe: '4', id: '45', name: '메르티', cv_ja: '코하라 코노미', spec: '<p>생일 : 9/28</p> <p>종족 : 아델라 악마</p> <p>키 : 154cm</p> <p>체중 : 53kg</p>', desc: '이상한 요술을 부리는 마법사로 <br>서커스단에 들어간 악마 소녀.<br> 서커스단과 함께 여러 지역을 돌아다니며<br> 인간과의 교류가 늘어나면서 인간이 되고 싶다고 생각한다.' },
  ...
  { tribe: '5', id: '54', name: '로잘리', cv_ja: '히라츠카 사에', spec: '<p>생일 : 12/28 </p> <p>종족 : 로스트엘프</p> <p>키 : 158cm</p> <p>체중 : 5.9kg * 엘프는 매우 가볍다.</p>', desc: '평소 나무 아래에 앉아 ‘류트’라는 악기를 연주하면<br> 휴식을 취하는 것을 좋아한다.<br> 조용한 성격이라 시끄러운 것을 싫어한다.' },
  { tribe: '5', id: '55', name: '애슐', cv_ja: '오미가와 치아키', spec: '<p>생일 : </p> <p>종족 : 다크엘프</p> <p>키 : 162cm</p> <p>체중 : 6.2kg * 엘프는 매우 가볍다.</p>', desc: '마조히즘 성향의 과격한 다크 엘프. <br>가족의 반대를 무릅쓰고 희망의 땅으로 향했다가 <br>잔혹한 현실에 눈을 뜨게 된다.' },
