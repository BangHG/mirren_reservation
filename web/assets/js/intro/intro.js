...
const angelList = [
  ...
  { tribe: '3', id: '31', name: '야요이', cv_ja: '아마미야 소라', spec: '<p>생일: 3/7</p> <p>종족: 오카즈 반수 </p> <p>키: 132cm</p> <p>체중 :31kg</p>', desc: '상냥하고 따뜻한 마음을 가지고 있고 모성애가 강하다. <br>그녀는 폰티 제국에서 재위 기간이 <br>두번째로 긴 군주이기도 했다.' },
  { tribe: '3', id: '32', name: '아넥스', cv_ja: '오나카 아이', spec: '<p>생일: 11/23</p> <p>종족: 오카즈 반수 </p> <p>키: 165cm</p> <p>체중 :55kg</p>', desc: '아기 때 숲에 버려졌지만 <br>씩씩하고 명랑한 성격을 가지고 있다. <br>천둥번개를 조종하는 능력을 가지고 있어서 <br>많은 음유시인들은 그녀를 천둥의 요괴라고 부르기도 한다.' },
  { tribe: '3', id: '33', name: '코스모스', cv_ja: '모니시타 치사키', spec: '<p>생일: 3/10</p> <p>종족: 오카즈 반수 </p> <p>키:  148cm</p> <p>체중: 40kg</p>', desc: '겁도 많고 수줍음도 많다.<br> 친해지면 애교도 많고 들이대는 성격. <br>허약한 체질이기 때문에 성흔이 되기 어려웠지만 자신의 힘을 증명하여 성흔이 되었다.' },
  { tribe: '3', id: '34', name: '마키', cv_ja: '타무라 유카리', spec: '<span>생일 : 3/15</span> <span>종족 : 오카즈 반수 </span> <span>키 :  145cm</span> <span>체중 : 40kg</span>', desc: '화이트&블랙 컬러의 긴 양 갈래 머리와 <br>오드아이 눈동자를 가지고 있다. <br>평소에는 매우 사납지만, <br>주인 앞에서는 한 마리의 순한 양이 된다.' },
  { tribe: '3', id: '35', name: '샌디', cv_ja: '치넨 아키호', spec: '<span>생일 : 3/18</span> <span>종족 : 콜른 반수 </span> <span>키 :  141cm</span> <span>체중 : 38kg</span>', desc: '매사 적극적으로 남을 돕고<br> 믿음직한 모습을 보여주려고 하지만 <br>강약 조절이 부족해 매번 일을 <br>엉망으로 만들어 버리는 천진난만한 소녀.' },
  ...
  { tribe: '4', id: '44', name: '쿠로신', cv_ja: 'X', spec: '<span>생일 : 5/25</span> <span>종족 : 플레임 악마</span> <span>키 : 157cm</span> <span>체중 : 45kg</span>', desc: '다른 세계에서 온 인기 아이돌이자 플레임 데빌의 둘째 공주. <br>말이나 행동이 평범한 여고생 같지만, <br>화가 나면 심한 장난으로 보복하는 귀여운 악마.' },
